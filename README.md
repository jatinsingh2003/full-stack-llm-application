...
* **OpenAI:** We'll call two different API's from OpenAI: 
Embeddings API (via client.embeddings.create) to embed webpage text and user queries.
Chat Completions API (via client.chat.completions.create) to generate context-aware answers using GPT-4.1 / GPT-4.1-mini (or any LLM you configure).
